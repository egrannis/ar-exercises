...
## can also just do Store.find(1) implicit that's it the ID. Usually find is exclusively for IDs becuase it req integers

@store2 = Store.find_by(id: 2)

@store1.name = "Emma"
# @store1.update(name: "Emma") # want to update the column of name, don't pass it a symbol
# when passing a symbol, is usually when you are creating it
puts @store1.name
